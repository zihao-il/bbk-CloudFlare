...
const md2Color = ref<string>('themeAct-color')
const md2DColor = ref<string>('')
const md3Color = ref<string>('')
const md3DColor = ref<string>('')
const langBtnZh = ref<string>('themeAct-color')
const langBtnEh = ref<string>('')
...
const setThemeMod = (): void => {
    const themeMod = store.ThemeMod
    if (themeMod) {
...
const setThemeColor = (): void => {
    const ThemeColor = store.ThemeColor
    if (ThemeColor) {
        setTheme(ThemeColor)
    }
}

const setInitLang = (): void => {
...
type ThemeModType = 'Md2亮色' | 'Md2暗色' | 'Md3亮色' | 'Md3暗色'

const ThemeMod = (mod: ThemeModType, isClear: boolean): void => {
